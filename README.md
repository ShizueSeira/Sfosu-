...
![SFosu! home screen](screenshots/Sfosu_Screens/Sfosu_Home_Screen.png)
...
![GitHub Environment](screenshots/Continue/Github_Environment.png)
...
![VS Code environment](screenshots/VSCode/VSCode_Environment.png)
...
![Continue Open Router](screenshots/Continue/Continue_Open_Router.png)
...
![Continue Open Router Website](screenshots/Continue/Continue_Open_Router_Website.png)
...
![Continue Poolside Laguna Use](screenshots/Continue/Continue_Poolside_Laguna_Use.png)
...
![SFosu! global chat screen](screenshots/Sfosu_Screens/Sfosu_Global_Chat_Screen.png)
...
![SFosu! artist screen](screenshots/Sfosu_Screens/Sfosu_Artist_Screen.png)
...
![SFosu! artist related tab](screenshots/Sfosu_Screens/Sfosu_Artist_Related_Tab.png)
...
![SFosu! artist details tab](screenshots/Sfosu_Screens/Sfosu_Artist_Details_Tab.png)
...
![Artist list view button layout](screenshots/Artist/Artist_List_View_Button_Layout.png)

![Artist list view button layout settings](screenshots/Artist/Artist_List_View_Button_Layout_settings.png)
...
![Add new artist record](screenshots/New_Records/New_Artist_Record.png)
...
![SFosu! beatmap screen](screenshots/Sfosu_Screens/Sfosu_Beatmap_screen.png)
...
![SFosu! beatmap related tab](screenshots/Sfosu_Screens/Sfosu_Beatmaps_Related_Tab.png)
...
![SFosu! beatmap details tab](screenshots/Sfosu_Screens/Sfosu_Beatmaps_Details_Tab.png)
...
![Beatmap record type selection](screenshots/New_Records/New_Beatmap_Record_Type.png)
...
![Beatmap standard record layout](screenshots/New_Records/New_Beatmap_osustd_Record_Type.png)
...
![Beatmap mania record layout](screenshots/New_Records/New_Beatmap_osumania_Record_Type.png)
...
![Beatmap Record Types Default and Mania Layout](screenshots/Beatmap/Beatmap_Record_Types_Default_And_Mania_Layout.png)
...
![SFosu! score submissions screen](screenshots/Sfosu_Screens/Sfosu_Score_Submissions_Screen.png)
...
![Add new score submission record](screenshots/New_Records/New_Score_Submission_Record.png)
...
![SFosu! score submissions details tab](screenshots/Sfosu_Screens/Sfosu_Score_Submissions_Details_Tab.png)
...
![SFosu! accounts screen](screenshots/Sfosu_Screens/Sfosu_Accounts_Screen.png)
...
![SFosu! accounts related tab](screenshots/Sfosu_Screens/Sfosu_Accounts_Related_Tab.png)
...
![SFosu! accounts details tab](screenshots/Sfosu_Screens/Sfosu_Accounts_Details_Tab.png)
...
![Add new clan record](screenshots/New_Records/New_Clan_Record.png)
...
![SFosu! contacts screen](screenshots/Sfosu_Screens/Sfosu_Contacts_Screen.png)
...
![SFosu! contacts related tab](screenshots/Sfosu_Screens/Sfosu_Contacts_Related_Tab.png)
...
![SFosu! contacts details tab](screenshots/Sfosu_Screens/Sfosu_Contacts_Details_Tab.png)
...
![Add new contact record](screenshots/New_Records/New_Contact_Record.png)
...
![SFosu! dashboard screen](screenshots/Sfosu_Screens/Sfosu_Dashboard_screen.png)
...
![SFosu! reports screen](screenshots/Sfosu_Screens/Sfosu_Reports_Screen.png)
...
![Artist details report outline](screenshots/Reports/Report_Artist_and_established_beatmaps_details.png)
...
![Artist details report filters](screenshots/Reports/Report_Artist_and_established_beatmaps_details.png)
...
![Top 10 scores report outline](screenshots/Reports/Report_Top_10_Most_Gained_scores_outline.png)
...
![Top 10 scores report filters](screenshots/Reports/Report_Top_10_Most_Gained_scores_filters.png)
...
![Top 10 PP plays standard outline](screenshots/Reports/Report_Top_10_highest_PP_plays_standard_outline.png)
...
![Top 10 PP plays standard filters](screenshots/Reports/Report_Top_10_highest_PP_plays_standard_Filters.png)
...
![Top 5 PP plays mania outline](screenshots/Reports/Report_Top_10_highest_PP_plays_mania_outline.png)
...
![Top 5 PP plays mania filters](screenshots/Reports/Report_Top_10_highest_PP_plays_mania_Filters.png)
...
![SFosu! chatter screen](screenshots/Sfosu_Screens/Sfosu_Chatter_Screen.png)
...
![SFosu! chat messages screen](screenshots/Sfosu_Screens/Sfosu_Chat_Messages_Screen.png)
...
![SFosu! chat messages related tab](screenshots/Sfosu_Screens/Sfosu_Chat_Message_Related_Tab.png)
...
![SFosu! chat messages details tab](screenshots/Sfosu_Screens/Sfosu_Chat_Message_Details_Tab.png)
...
![Custom objects overview](screenshots/Sfosu_Screens/Sfosu_Custom_Objects.png)
...
![Artist fields](screenshots/Artist/Artist_Fields.png)
...
![Artist number of beatmaps rollup](screenshots/Artist/Artist_Number_Of_Beatmaps_Rollup.png)
...
![Beatmap fields](screenshots/Beatmap/Beatmap_Fields.png)
...
![Beatmap artist master-detail](screenshots/Beatmap/Beatmap_Artist_Master_Detail.png)
...
![Beatmap status picklist](screenshots/Beatmap/Beatmap_Status_Picklist.png)
...
![Beatmap key count picklist](screenshots/Beatmap/Beatmap_Key_Count_Picklist.png)
...
![Beatmap key count field visibility](screenshots/Beatmap/Beatmap_Key_Count_Field_Visibility.png)
...
![Beatmap play time formula](screenshots/Beatmap/Beatmap_Play_Time_Formula.png)
...
![Standard object account clans](screenshots/Sfosu_Screens/Sfosu_Standard_Object_Account_Clans.png)
...
![Standard object contact osu!PlayProfile](screenshots/Sfosu_Screens/Sfosu_Standard_Object_Contact_osuPlayProfile.png)
...
![Chat Moderation Filter Configure Start](screenshots/Flows/Flows_Chat_Moderation_Filter_Configure_Start.png)
...
![Chat Moderation Filter Decision](screenshots/Flows/Flows_Chat_Moderation_Filter_Decision.png)
...
![Chat Moderation Filter Update Records](screenshots/Flows/Flows_Chat_Moderation_Filter_Update_Records.png)
...
![Chat Moderation Filter Flow Diagram](screenshots/Flows/Flows_Chat_Moderation_Filter_FIgure.png)
...
![Flow list](screenshots/Flows/Flows_List.png)
...
![Test Setup](screenshots/Test_Cases/Test_Flag_Inappropriate_Content_Chat_Moderation_Filter_Test_Setup.png)
...
![Initial Triggering Record](screenshots/Test_Cases/Test_Flag_Inappropriate_Content_Chat_Moderation_Filter_Test_Initial_Triggering_Record.png)
...
![Test Assertions](screenshots/Test_Cases/Test_Flag_Inappropriate_Content_Chat_Moderation_Filter_Test_Assertions.png)
...
![Test Details](screenshots/Test_Cases/Test_Flag_Inappropriate_Content_Chat_Moderation_Filter_Test_Details.png)
...
![Test Results](screenshots/Test_Cases/Test_Flag_Inappropriate_Content_Chat_Moderation_Filter_Test_Results.png)
...
![Get Notifications Developers Configure Start](screenshots/Flows/Flows_Get_Notifications_Developers_Configure_Start.png)
...
![Get Notifications Developers Get Records](screenshots/Flows/Flows_Get_Notifications_Developers_Get_Records.png)
...
![Get Notifications Developers Assignment](screenshots/Flows/Flows_Get_Notifications_Developers_Assignment.png)
...
![Get Notifications Developers Action One](screenshots/Flows/Flows_Get_Notifications_Developers_Action_One.png)

This action sends the first chat bell alert notification once the recipient and notification type are ready.

![Get Notifications Developers Action Two](screenshots/Flows/Flows_Get_Notifications_Developers_Action_Two.png)
...
![Test Setup](screenshots/Test_Cases/Test_Chat_Bell_Notification_Test_Setup.png)
...
![Initial Triggering Record](screenshots/Test_Cases/Test_Chat_Bell_Notification_Initial_Triggering_Record.png)
...
![Set Assertions](screenshots/Test_Cases/Test_Chat_Bell_Notification_Set_Assertions.png)
...
![Set Test Details Trigger Path](screenshots/Test_Cases/Test_Chat_Bell_Notification_Set_Test_Details_Trigger_Path.png)
...
![Test Results](screenshots/Test_Cases/Test_Chat_Bell_Notification_Results.png)
...
![Beatmap Qualify Map Update Records](screenshots/Flows/Flows_Beatmap_Qualify_Map_Update_records.png)
...
![Update Beatmap Status Screen](screenshots/Flows/Flows_Update_Beatmap_Status_Screen.png)
...
![Update Beatmap Status Get Records](screenshots/Flows/Flows_Update_Beatmap_Status_pcs_BeatmapStatis_resource.png)
...
![Update Beatmap Status Update Records](screenshots/Flows/Flows_Update_Beatmap_Status_Update_Records.png)
...
![Authorized org in VS Code](screenshots/VSCode/VSCode_Authorized_Org.png)
...
![Apex classes in VS Code](screenshots/VSCode/VSCode_Apex_Classes.png)
...
![LWC files in VS Code](screenshots/VSCode/VSCode_LWC.png)
...
![App Manager App](screenshots/App_Manager/App_Manager_App.png)
...
![App Manager Navigation Items](screenshots/App_Manager/App_Manager_Navigation_Items.png)
...
![App Manager User Profiles](screenshots/App_Manager/App_Manager_User_Profiles.png)
...
![App Manager App Details and Branding](screenshots/App_Manager/App_Manager_App_Details_And_Branding.png)
